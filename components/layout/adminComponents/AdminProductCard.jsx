...
export default function AdminProductCard({ product }) {
  ...
  return (
    <div className="group bg-card rounded-lg overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300 border border-neutral border-border/50 flex flex-col">
            ...
            {product.variants?.map((variant) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={cn(lowStock && "text-orange-600 font-semibold")}
                  >
                    ({variant.stock})
                  </span>
                </div>
      ...
      <Link href={`/admin/products/edit/${product.id}`}>
        <Button className="w-full text-xs bg-primarygreen-500 text-primarygreen-50 hover:bg-primarygreen-700 rounded-t-none rounded-2xl">
          Customize <Cog />
        </Button>
      </Link>
    </div>
