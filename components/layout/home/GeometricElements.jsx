  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-20 left-20">
        <div
          className="w-32 h-[1px] opacity-0 animate-line-expand animation-delay-1000"
          style={{
        ...
        />
        <div
          className="w-[1px] h-32 opacity-0 animate-line-expand animation-delay-1200"
          style={{
            transformOrigin: "top",
            background:
      ...
      <div className="absolute bottom-20 left-20 flex flex-col">
        <div
          className="w-[1px] h-32 opacity-0 animate-line-expand animation-delay-1400"
          style={{
        ...
        />
        <div
          className="w-32 h-[1px] opacity-0 animate-line-expand animation-delay-1600"
          style={{
            transformOrigin: "left",
            background:
              "linear-gradient(to right, transparent, hsl(156 45% 25% / 0.3), transparent)",
